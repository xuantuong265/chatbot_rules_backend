                ...
                <div class="row">
                                ...
                                <table class="table-shopping-cart">
                                    ...
                                    @foreach($products as $key => $product)
                                        <tr class="table_row">
                                            ...
                                            <td class="column-3">${{ number_format($price = $product->price, 0, '', '.') }}</td>
                                            <td class="column-4">
                                            ...
                                            <td class="column-5">${{ number_format($priceEnd = $price * $carts[$product->id], 0, '', '.') }}</td>
                                            <td class="column-5">
                                                <a class="btn btn-danger btn-sm" href="{{ route('delete.cart',[$product->id]) }}">
                                                <i class="fa fa-trash-o fa-times" data-id="{{$product->id}}"></i></a>
                                            </td>
                                        </tr>
                                        @php
                                            $total+= $priceEnd;
                    ...
                    <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
                        <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                            ...
                            <button onclick="myFunction()" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
                               Đặt Hàng
                            </button>
                            <p id="demo"></p>
                        </div>
...
<script>
    function myFunction() {
      let text = "Bạn chắc chắn muốn đặt hàng ???\nEither OK or Cancel.";
